        ...
        <div className="mb-10 text-center animate-fade-in-up">
          ...
          <h1 className="mb-3">
            <span className="block text-4xl sm:text-5xl font-bold tracking-tight leading-[1.1]">
              ...
              <span className="bg-gradient-to-r from-[#7c3aed] via-[#a78bfa] to-[#7c3aed] bg-[length:200%_auto] animate-gradient-shift bg-clip-text text-transparent">
                Subscriptions
              </span>
            </span>
          </h1>
          ...
          <p className="mx-auto max-w-lg text-sm sm:text-base leading-relaxed text-white/40">
            Create, manage, and automate recurring payments on the Stellar blockchain.
          </p>
